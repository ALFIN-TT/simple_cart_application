...
import com.alfin.productlistingapp.core.data.network.SafeApiRequest
import com.alfin.productlistingapp.core.data.state.State
import com.alfin.productlistingapp.core.data.state.handle
...
import com.alfin.productlistingapp.data.roomdb.ProductDao
...
class ProductRepositoryImpl @Inject constructor(
    ...
    override suspend fun getProducts(
        limit: Int,
        page: Int
    ): Response<Products> = productApi.getProducts(limit = limit, page = page)
    ...
    override suspend fun addToCart(product: Product):Long = productDao.addToCart(product)
